...
public class RamseteCommand extends CommandBase {
  ...
  public void execute() {
    ...
    double leftOutput = leftRightOutput.fst + leftPid.calculate(drive.getLeftVel(), leftSpeedSetpoint);
    double rightOutput = leftRightOutput.snd + rightPid.calculate(drive.getRightVel(), rightSpeedSetpoint);
