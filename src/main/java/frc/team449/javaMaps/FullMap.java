    ...
    public static RobotMap createRobotMap() {
        ...
        var driveSim =
                new DifferentialDrivetrainSim(
                        LinearSystemId.identifyDrivetrainSystem(DRIVE_FF_KV, DRIVE_FF_KA, DRIVE_ANGLE_FF_KV, DRIVE_ANGLE_FF_KA, DRIVE_TRACK_WIDTH),
                        DCMotor.getNEO(3),
                        DRIVE_GEARING,
                        DRIVE_TRACK_WIDTH,
                        DRIVE_WHEEL_RADIUS,
        ...
        List<Command> autoStartupCommands = List.of(
                ...
                .andThen(ThreeBallAuto.createCommand(drive,
                cargo,
                DRIVE_KP_VEL,
                DRIVE_KD_VEL,
