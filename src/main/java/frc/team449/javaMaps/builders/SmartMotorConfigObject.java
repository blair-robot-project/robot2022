 ...
 *
 * <p>You can set config options in this and then pass this to the {@link SmartMotor} constructor.
 *
 * <p>It's very similar to {@link SmartMotorBuilder} but has getters.
 *
...
public class SmartMotorConfigObject {
  ...
  public SmartMotorConfigObject setPerGearSettings(
  ...
  public SmartMotorConfigObject setControlFrameRatesMillis(
  ...
  public SmartMotorConfigObject setVoltagePerCurrentLinReg(
