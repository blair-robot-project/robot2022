...
public class FiveBallStart {
  public static final Pose2d start =
          new Pose2d(9.17, 5.86, Rotation2d.fromDegrees(45.81));
  public static final Pose2d pose1 =
          new Pose2d(11.01, 6.22, Rotation2d.fromDegrees(12.99));
  public static final Pose2d pose2 =
          new Pose2d(11.41, 7.28, Rotation2d.fromDegrees(154.34));
  public static final Pose2d end =
          new Pose2d(9.59, 7.64, Rotation2d.fromDegrees(178.26));
  ...
  public static Command createCommand(
          ...
          Field2d field) {
    var traj = TrajectoryGenerator.generateTrajectory(List.of(start, pose1, pose2, end), trajConfig.get());
