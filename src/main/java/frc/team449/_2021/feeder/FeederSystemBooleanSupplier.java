 ...
 * inside of a command instead of a subsystem, preventing the use of a BooleanSupplierSubsystemBased
 * To be clear, this exists b/c 2020 code was a bit of a mess, not b/c this is a good solution to
 * the issue If this issue recurs, this code can be adapted to take any boolean-supplying method
 * from any default command
 */
